...
import { getByParams, updateStatus, deleteMaterial, 
         updateMaterial, addMaterial  } from '@/api/basicData/supplier'
...
const confirmButton = async () => {
    let params={
        id:modalValue.value.supplier_id,
        supplierName:modalValue.value.supplier_name,
        contact:modalValue.value.contact,
        tel:modalValue.value.tel,
...
const confirmButtonAdd = async () => {
    let params={
        supplierName:modalValueAdd.value.supplier_name,
        contact:modalValueAdd.value.contact,
        tel:modalValueAdd.value.tel,
