...
import { getByParams, updateStatus, deleteMaterial, 
         updateMaterial, addMaterial  } from '@/api/basicData/store'
...
const confirmButton = async () => {
    let params={
        id:modalValue.value.store_id,
        storeName:modalValue.value.store_name,
        storeCode:modalValue.value.store_code,
...
const confirmButtonAdd = async () => {
    let params={
        storeName:modalValueAdd.value.store_name,
        storeCode:modalValueAdd.value.store_code,
