...
const confirmButton = async () => {
    let params={
        id:modalValue.value.material_id,
        materialName:modalValue.value.material_name,
        unit:modalValue.value.unit,
...
const confirmButtonAdd = async () => {
    let params={
        materialName:modalValueAdd.value.material_name,
        unit:modalValueAdd.value.unit,
